...
class Arguments:
    def __init__(self, stage='pretrain'):
        ...
        self._parser.add_argument('--conditional_class', action='store_true', default=False, help='condition the model on class labels') # Set to False
    ...
    def parse_inversion_args(self):
        ...
        self._parser.add_argument('--use_pred_pose', action='store_true', default=False, help='if use poses pred by CMR')
